package com.zhang.gmall0826.common.constat;
...
public class GmallConstant {
    ...
    public static final String ES_INDEX_ALERT="gmall_coupon_alert0826";
    public static final String ES_INDEX_SALE="gmall0826_sale_detail";
